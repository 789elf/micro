...
public class D09_findEmail {
	...
	public void checkEmail(String text) {
		...
		Pattern regex = Pattern.compile("[a-zA-Z0-9]+[@][a-z]+[\\.]+[a-z]+[\\.]?[a-z]+");  //[\\.][a-z]+");
	...
	public static void main(String[] args) {
		...
		D09_findEmail findEmail = new D09_findEmail();
		
		String text = findEmail.getEmail();
		findEmail.checkEmail(text);
	}
	
	public String getEmail() {
		
		String text ="zeeny@chosun.com\r\n" + 
